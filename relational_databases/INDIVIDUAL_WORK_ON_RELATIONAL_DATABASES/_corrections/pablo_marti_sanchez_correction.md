...
| 2. Accessing the database | 2.0 | 1.9 |
| 3. Transactions and concurrency control | 3.0 | 2.95 |
...
High-quality work with very few deductions. The database schema is well-designed and the documentation is generally thorough and clearly presented. The only weaknesses are that a few tables fall short of the 100-record requirement and the access verification does not clearly demonstrate the denied-access scenario. Both are minor points in an otherwise excellent submission.
---
...
**Score: 0.0 / 0.2** - Tables below 100 records (required).
...
**Score: 0.2 / 0.3** Access verification present but denied scenario not clearly shown.

### Exercise 2.5 - View for Derived/Composite Attribute (0.6 points)

**Score: 0.6 / 0.6**

**Section 2 subtotal: 1.9 / 2.0**
