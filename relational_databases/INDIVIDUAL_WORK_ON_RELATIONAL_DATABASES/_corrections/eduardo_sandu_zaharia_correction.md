...
| 3. Transactions and concurrency control | 3.0 | 1.25 |
...
Overall a competent submission with most sections well-executed and clearly documented. The main identified issue is a conceptual error in the concurrency problem analysis: the schedule exhibits a lost update problem, not the type identified. A more careful reading of the schedule against the definitions covered in class would have caught this.
---
